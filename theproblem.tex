...
Lai \cite{Lai2006} proposed a cluster based segmentation algorithm,
and random walks segmentation extensions \cite{Lai2008} and  \cite{Lai2009}.
Golovinskiy \cite{Golovinskiy2009} also presented a clustering technique with special emphasis on edge and face consistency.
...
However all the previous methods except Gelfand's cannot be directly applied to segment mechanical parts.
Nevertheless, Yi \cite{Yi2014} improved Gelfand's method making it more robust to noise, and giving extra primitive information(e.g. normal of a plane, center of a sphere, etc ).
