...
Part analysis goes beyond part segmentation, it also includes analysing part semantics and relations between them. 
...
Segment symmetry analysis can be used to compute possible rotation or translation axis in the parts.
