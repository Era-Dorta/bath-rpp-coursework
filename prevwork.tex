...
Variational shape approximation has also been studied for characterization purposes of engineered objects \cite{Cohen-Steiner2004}.
An abstraction method, to extract a characteristic curve networks was proposed by \cite{Mehra2009}.
Nevertheless, 
