...
\begin{figure}
	...
	\caption{Streamcomet depiction with its degrees of freedom outlined.}
	\label{fig:streaComent}
\end{figure}

\cite{Laramee2005} presented the streamcomet and a fast animating technique.
A streamcomet, as shown in Figure~\ref{fig:streaComent}, is an extension of a streamline, they move along the path of a stream line, with adjustable head position, length and translucency of tail, and variable animation speed.
