...
Furthermore, Lowe showed that even though animations have become a generalized tool for visualizing dynamic systems, special care have to be taken as users can fail at extract the necessary information due to the nature of the animation~\cite{Lowe2014}.
...
\begin{figure}
	...
	\begin{minipage}[t]{.45\textwidth}
		...
		\caption{Arrows placed on streamlines paths in on a 3D surface~\cite{loffelmann1998}.}
