...
This simulations did not include including solid-fluid coupling, that was later proposed in Grids by Carlson \cite{Carlson2004}. 
On the other hand, Muller \cite{Muller2004} did the same for SPH simulations, that Akinci \cite{Akinci2012} further improveded with the inclusion of friction and dragging.
