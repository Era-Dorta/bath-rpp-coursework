...
This stage involves placing arrows to convey part movement, either translational, cap or side, on the edge of each junction.
...
However, if this is not enough, the type of the arrow can be switched as well, from cap to side or viceversa.
