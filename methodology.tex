...
\begin{ganttchart}{1}{16}
	...
	\ganttbar{Part Segmentation}{1}{2} \\
	\ganttlinkedbar{Fluid simulation}{3}{7}
	\ganttnewline
	\ganttmilestone{Milestone}{7}
	\ganttnewline
	\ganttbar{Flow visualization}{8}{10}
	\ganttnewline
	\ganttlinkedbar{Solid parts visualization}{11}{12}
	\ganttnewline
	\ganttlinkedbar{Key frames visualization}{13}{16}
