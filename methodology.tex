...
\begin{ganttchart}[
	...
	\ganttgroup{Part Analysis}{1}{4} \ganttnewline
	\ganttbar{Preparation}{1}{1} \ganttnewline
	\ganttbar{Part Segmentation}{2}{2} \ganttnewline
	\ganttbar{Part Characterization}{3}{4} \ganttbar{}{8}{8} \ganttnewline
	\ganttgroup{Fluid Simulation}{4}{8} \ganttnewline
	\ganttbar{Fluid Only}{4}{6} \ganttbar{}{8}{8} \ganttnewline
	\ganttbar{Solid-Fluid Coupling}{6}{7} \ganttbar{}{11}{11} \ganttnewline
	\ganttbar{With hydraulic parts}{8}{8} \ganttnewline
	%\ganttmilestone{Milestone}{7}
	%\ganttnewline
	\ganttgroup{Visualization}{8}{16} \ganttnewline
	\ganttbar{Flow}{8}{11} \ganttbar{}{14}{14} \ganttnewline
	\ganttbar{Solid Parts}{11}{14} \ganttnewline
	\ganttbar{Key Frames}{14}{16}
