...
Given the characteristics of our problem, an physically accurate simulation with two way solid-fluid coupling is needed.
However, effects such as foams, droplets, etc, are irrelevant in this area.
